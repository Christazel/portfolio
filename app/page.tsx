  ...
  return (
    <>
      ...
      <main className="container-page">
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="mt-4 max-w-2xl text-zinc-400">
                    Fokus pada Next.js + Tailwind untuk web, Express/MongoDB untuk backend, dan Flutter
                    untuk mobile. Suka bikin dashboard, sistem manajemen, dan integrasi API.
                  </p>
                ...
                <div className="shrink-0">
                  <div className="relative grid h-24 w-24 place-items-center rounded-2xl border border-zinc-800 bg-zinc-900/50 md:h-28 md:w-28">
                    <div className="absolute inset-0 rounded-2xl bg-[radial-gradient(250px_circle_at_30%_20%,rgba(255,255,255,0.08),transparent_60%)]" />
                    <span className="relative text-xl font-semibold text-zinc-200 md:text-2xl">
                      YC
                    </span>
                  </div>
                </div>
        ...
        <Section id="about" title="About" subtitle="Ringkas, jelas, dan menunjukkan value kamu.">
          <Reveal>
        ...
        <Section id="projects" title="Projects" subtitle="Pilih 2–6 project terbaik. Kasih link demo/repo.">
          <div className="grid gap-4 md:grid-cols-2">
            {projects.map((p, idx) => (
              <Reveal key={p.title} delay={idx * 0.06}>
                <div className="card p-6 card-hover relative overflow-hidden">
                  {/* glow on hover */}
                  <div className="pointer-events-none absolute -inset-24 opacity-0 transition-opacity duration-300 hover:opacity-100 [background:radial-gradient(400px_circle_at_30%_20%,rgba(59,130,246,0.12),transparent_60%)]" />

                  <h3 className="relative text-lg font-semibold">{p.title}</h3>
                  <p className="relative mt-2 text-sm text-zinc-400">{p.desc}</p>
          ...
          <Reveal>
            <div className="card p-6 md:p-8 card-hover">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <a className="btn" href="https://wa.me/6282150754301" target="_blank" rel="noreferrer">
                  Chat WhatsApp
                </a>
                <a
                  className="btn"
