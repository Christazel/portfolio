export default function Footer() {
  return (
    <footer className="relative left-1/2 min-h-[82svh] w-screen -translate-x-1/2 overflow-hidden bg-zinc-100 text-zinc-950">
      ...
      <div className="relative z-10 flex min-h-[82svh] flex-col justify-between px-5 py-8 sm:px-8 md:px-12 lg:px-16">
